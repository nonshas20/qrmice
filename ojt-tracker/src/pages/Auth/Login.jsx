...
function Login() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="hidden md:block md:w-1/2 bg-gradient-to-tr from-primary-600 to-purple-600 overflow-hidden">
        <div className="h-full w-full flex flex-col justify-center items-center p-12 text-white">
          <div className={`max-w-md text-center transition-all duration-1000 delay-300 ${animate ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            ...
            <h2 className="text-3xl font-bold mb-2">OJT Tracker</h2>
            <p className="text-lg opacity-90 mb-8">Track your On-the-Job Training progress with ease</p>
